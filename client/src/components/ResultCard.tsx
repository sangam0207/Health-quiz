      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button
              onClick={handleShare}
              className="bg-green-200 backdrop-blur-sm text-gray-700 px-4 py-2 rounded-lg hover:bg-green-300 hover:cursor-pointer transition-all flex items-center gap-2"
            >
              {copiedToClipboard ? (
                <>
            ...
            <button
              ...
              className="bg-blue-200 backdrop-blur-sm text-gray-700 px-4 py-2 rounded-lg hover:bg-blue-300 hover:cursor-pointer transition-all flex items-center gap-2"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
